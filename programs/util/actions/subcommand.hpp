...
class fullon_util_exception_handler {
public:
   fullon_util_exception_handler() {}
   ~fullon_util_exception_handler() {}
   void print_exception() noexcept;
};

template<class subcommand_options, class exception_handler = fullon_util_exception_handler>
class sub_command {
protected:
