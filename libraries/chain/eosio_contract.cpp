...
void apply_eosio_updateauth(apply_context& context) {
   ...
   EOS_ASSERT( update.permission.prefix() != config::system_account_name, action_validate_exception,
               "Permission names that start with '${p}.' are reserved", ("p", config::system_account_name) );
