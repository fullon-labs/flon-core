...
//       in the persistent file) at fullon startup.
//
//  my_finalizers_t:
//  ---------------
...
namespace eosio::chain {
   ...
   public:
      ///
      /// Version 0: fullon 1.0.0 RC2 - File has fixed packed sizes with inactive safety info written to the end
      ///                               of the file. Consists of [finalizer public_key, FSI]..
      /// Version 1: fullon 1.0.0 RC3 - File has inactive FSIs written at the beginning of the file. Uses crc32
