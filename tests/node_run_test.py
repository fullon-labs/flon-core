...
errFileName=f"{cluster.nodeLogPath}/node_00/stderr.txt"
...
try:
    ...
    xferAmount=Utils.coreAssetFrom("1.2345")
    ...
    node.processClientCmd(signCmd, "Sign and push a transaction", False, True)
