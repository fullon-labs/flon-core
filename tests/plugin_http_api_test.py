...
class HttpCategoryConfig:
    ...
    def port(self, category: str):
        return self.ports[category] if self.ports else HttpCategoryConfig.default_port
   ...
   # kill node. wallet shuts down automatically
    ...
    def test_ChainApi(self) :
        ...
        payload = {"ref_block_num":"100",
                   ...
                   "signatures": [],
                   "authorizations": [],
                   "available_keys":[Utils.makePubKey("4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq"),
                   Utils.makePubKey("7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA"),
                   Utils.SysAccountPubKeyDefault]}
        ret_json = self.node.processUrllibRequest(resource, command, payload, endpoint=endpoint)
        self.assertEqual(ret_json["code"], 500)
    ...
    def test_WalletApi(self) :
        ...
        payload = [signed_transaction,
                   [Utils.makePubKey("696giL6VxeJhtEgKtWPK8aQeT8YXNjw2a7vE5wHunffhfa5QSQ")],
