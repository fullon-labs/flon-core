...
#  - Start node in irreversible mode on blocklog
...
try:
    ...
    Utils.processFullOnUtilCmd("snapshot to-json --input-file {}".format(snapshotFile), "snapshot to-json", silentErrors=False)
    ...
    Utils.processFullOnUtilCmd("snapshot to-json --input-file {}".format(progSnapshotFile), "snapshot to-json", silentErrors=False)
    ...
    Utils.processFullOnUtilCmd("snapshot to-json --input-file {}".format(irrSnapshotFile), "snapshot to-json", silentErrors=False)
