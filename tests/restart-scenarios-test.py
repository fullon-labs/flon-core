...
try:
    ...
    wallet=walletMgr.create(walletName, [cluster.sysAccount,cluster.defproduceraAccount,cluster.defproducerbAccount])
    ...
    if not cluster.createAccounts(sysAccount):
