...
try:
    ...
    shipNodeNum = 0
    specificExtraNodeArgs[shipNodeNum]="--plugin eosio::state_history_plugin"
    ...
    if cluster.launch(prodCount=prodCount, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      specificExtraNodeArgs=specificExtraNodeArgs, extraNodeArgs=extraNodeArgs) is False:
