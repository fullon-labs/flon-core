...
#
# Similar scenario to node_forked_chain_test, except that there are only 3 producers and, after the "bridge" node is
...
try:
    ...
    extraNodeArgs=" --production-pause-vote-timeout-ms 0 "
    ...
    if cluster.launch(prodCount=2, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      specificExtraNodeArgs=specificExtraNodeArgs, extraNodeArgs=extraNodeArgs, onlySetProds=True) is False:
