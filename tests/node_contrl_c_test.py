...
try:
    ...
    specificExtraNodeArgs[totalProducerNodes] = "--plugin eosio::producer_plugin --plugin eosio::chain_api_plugin --plugin eosio::http_plugin "
    ...
    if cluster.launch(prodCount=1, topo="bridge", pnodes=totalProducerNodes,
                      ...
                      extraNodeArgs=extraNodeArgs) is False:
    ...
    for account in accounts:
        ...
        trans=nonProdNode.createInitializeAccount(account, cluster.sysAccount, fund=0, waitForTransBlock=True, buyGas=1.0000, exitOnError=True)
