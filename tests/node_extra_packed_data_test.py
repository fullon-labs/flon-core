...
###############################################################
# node_extra_packed_data_test
#
# Tests node accepts trx with extra data packed at the end.
#
###############################################################
...
try:
    ...
    if localTest and not dontLaunch:
        ...
        if pnodes > 1:
            specificExtraNodeArgs[pnodes - 1] = ""
        if pnodes > 3:
            specificExtraNodeArgs[pnodes - 2] = ""
    ...
    if dontLaunch:
        del walletAccounts[Utils.SysAccount]
