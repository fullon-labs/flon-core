...
class TestHelper(object):
    ...
    def createArgumentParser(includeArgs, applicationSpecificArgs=AppArgs(), suppressHelp: bool=False) -> argparse.ArgumentParser:
        ...
        if "--sanity-test" in includeArgs:
            thGrp.add_argument("--sanity-test", help=argparse.SUPPRESS if suppressHelp else "Validates node and keosd are in path and can be started up.", action='store_true')
