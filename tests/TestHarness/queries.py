...
class NodeQueries:
    ...
    def validateTransaction(trans):
        ...
        transStatus=NodeQueries.getTransStatus(trans)
    ...
    def getTransStatus(trans):
        cntxt=NodeQueries.Context(trans, "trans")
    ...
    def getBlockProducerByNum(self, blockNum, timeout=None, waitForBlock=True, exitOnError=True):
        ...
        return NodeQueries.getBlockAttribute(block, "producer", blockNum, exitOnError=exitOnError)
