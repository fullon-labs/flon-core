...
try:
    ...
    specificExtraNodeArgs[pnodes+1] = f' --sync-fetch-span 1 '
    specificExtraNodeArgs[pnodes+2] = f' --sync-fetch-span 5 '
    specificExtraNodeArgs[pnodes+3] = f' --sync-fetch-span 21 '
    specificExtraNodeArgs[pnodes+4] = f' --sync-fetch-span 89 '
    specificExtraNodeArgs[pnodes+5] = f' --sync-fetch-span 377 '
    specificExtraNodeArgs[pnodes+6] = f' --sync-fetch-span 1597 '
    ...
    specificExtraNodeArgs[pnodes+14] = f' --sync-fetch-span 200 --read-mode irreversible '
    specificExtraNodeArgs[pnodes+15] = f' --sync-fetch-span 2500 --read-mode irreversible '
    if cluster.launch(prodCount=prodCount, specificExtraNodeArgs=specificExtraNodeArgs, activateIF=activateIF, onlyBios=False,
        ...
        for line in lines:
            ...
            if m is not None:
                ...
                if irreversible:
                    ...
                    # See https://github.com/AntelopeIO/fullon/issues/806
