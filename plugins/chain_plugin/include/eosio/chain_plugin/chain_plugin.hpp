...
public:
   ...
   struct get_info_results {
      ...
      std::optional<uint32_t>              gas_per_cpu_ms;
      std::optional<uint32_t>              gas_per_net_kb;
      std::optional<uint32_t>              gas_per_ram_kb;
   ...
   struct get_account_results {
      ...
      std::optional<int64_t>     subjective_cpu_bill;
...
FC_REFLECT(eosio::chain_apis::read_only::get_info_results,
           (server_version)(server_version_string)(server_full_version_string)
