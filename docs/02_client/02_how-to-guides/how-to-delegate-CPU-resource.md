...
* Familiarize with the [`focli system delegatebw`](../03_command-reference/system/system-delegatebw.md) command and its parameters.
...
```sh
focli system delegatebw <from> <receiver> <stake_net_quantity> <stake_cpu_quantity>
```
...
```sh
focli system delegatebw bob alice "0 SYS" "0.01 SYS"
```
```json
