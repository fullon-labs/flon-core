...
## Command
A set of FullOn keys is required to create an account. The FullOn keys can be generated by using `focli create key`.

```sh
focli create account inita tester FU4toFS3YXEQCkuuw1aqDLrtHim86Gz9u3hBdcBw5KNPZcursVHq FU7d9A3uLe6As66jzN8j44TXJUqJSK3bFjjEEqR4oTvNAB3iM9SA
```
