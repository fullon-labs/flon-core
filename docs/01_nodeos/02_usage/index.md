...
* [Options](00_node-options.md) - Setting up `funod`; funod vs. plugin only options.
* [Configuration](01_node-configuration.md) - CLI vs. `config.ini` options; `funod` example.
