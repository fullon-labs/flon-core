...
The plugin creates per-block rollback checkpoints in a sibling `transaction_history_checkpoints` directory and restores them when the accepted chain switches forks.
