...
There are several ways to configure a `fonod` environment for development and testing. Which option to use largely depends on what the project goals are. Some practical options are provided below.
...
* [Configure fonod as a Local Single-node Testnet](00_local-single-node-testnet.md)
...
* [Configure fonod as a Local Two-Node Testnet](01_local-multi-node-testnet.md)
* [Configure fonod as a Local 21-Node Testnet](/tutorials/bios-boot-tutorial.md)
